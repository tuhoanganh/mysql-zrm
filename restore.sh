...
echo -e "${green}[INFO  ]${nc} level 0 at 07:00 then level 1 at 09:00, 11:00, 13:00, 15:00 and 17:00. So"
echo -e "${green}[INFO  ]${nc} you have to type the command mysql-zrm restore by hand and choose the right"
echo -e "${green}[INFO  ]${nc} directory... time by time. It's very annoying."
echo -e "${green}[INFO  ]${nc}"
...
echo -e "${green}[INFO  ]${nc} - Please Post any issues you meet when run this script, i'll try to fix this. Thanks"
echo -e "${green}[INFO  ]${nc} ===================================================================================="
echo -e "${green}[INFO  ]${nc}"
