...
echo -e "${green}[INFO  ]${nc} the db must be restored to 17:00 (latest backup), so you have to begin from"
echo -e "${green}[INFO  ]${nc} level 0 at 07:00 then level 1 at 09:00, 11:00, 13:00, 15:00 and 17:00.To do"
echo -e "${green}[INFO  ]${nc} this, you have to type the command mysql-zrm restore by hand and choose the"
echo -e "${green}[INFO  ]${nc} right directory... many tymes. It's very annoying."
echo -e "${green}[INFO  ]${nc}"
...
echo -e "${green}[INFO  ]${nc} - Configure MySQL-ZRM and backup database in few days"
echo -e "${green}[INFO  ]${nc} - Verify that all your backups is not FAILED or ERROR"
echo -e "${green}[INFO  ]${nc} - Try this script"
echo -e "${green}[INFO  ]${nc} ===================================================================================="
echo -e "${green}[INFO  ]${nc}"
echo -e "${green}[INFO  ]${nc} =================================${green}IMPORTANT NOTE${nc}====================================="
echo -e "${green}[INFO  ]${nc} Test this script in a Demo Server that have closest state with your real Server first"
